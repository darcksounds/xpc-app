            ...
            <nav style={{
                    ...
                    <div style={{ display: 'flex', gap: '4px' }}>
                        {links.map(link => (
                            <Link key={link.to} to={link.to} style={{
                                ...
                                color: location.pathname === link.to ? theme.accent : theme.muted,
                                background: location.pathname === link.to ? theme.accent + '15' : 'transparent',
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <button onClick={toggle} style={{
                        background: mode === 'dark' ? '#ffffff10' : '#0F172A10',
                    ...
                    {isMobile && (
                        <button onClick={() => setMenuOpen(!menuOpen)} style={{
                            ...
                            border: `1px solid ${theme.border}`,
                            borderRadius: '8px', padding: '8px 12px',
                            color: theme.text, fontSize: '20px', cursor: 'pointer'
                        }}>
                            {menuOpen ? '✕' : '☰'}
                        </button>
                    )}
